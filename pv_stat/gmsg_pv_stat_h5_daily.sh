...
RES_LOG_DIR="/data1/fans_api_log/chenkai3/gmsg_pv_stat/res_log/h5/";
DAILY_LOG_DIR=${RES_LOG_DIR}"daily/";

SCRIPT_DIR="/data1/fans_api_log/chenkai3/scripts/";
SCRIPT_NAME="gmsg_pv_stat_h5.sh";
...
#第三步：生成csv文件
res_data_file=${yesterday}"-"${yesterday}"_h5_pv_daily.csv";
