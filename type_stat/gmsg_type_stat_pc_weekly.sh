...
#作者：陈凯
#日期：2015/01/06
#对应crontab：30 3 * * 1 gmsg_type_stat_pc_weekly.sh

RES_LOG_DIR="/data1/fans_api_log/chenkai3/gmsg_type_stat/res_log/pc/";
WEEKLY_LOG_DIR=${RES_LOG_DIR}"weekly/";

SCRIPT_DIR="/data1/fans_api_log/chenkai3/scripts/";
BASE_SCRIPT=${SCRIPT_DIR}"gmsg_type_pc_stat.sh";
...
#第三步：生成最终结果
res_data_file=${WEEKLY_LOG_DIR}${begin_date}"-"${end_date}"_7day_gmsg_type_stat_pc.csv";
#echo ${res_data_file};
